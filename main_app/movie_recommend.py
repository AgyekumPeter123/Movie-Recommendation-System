...
def main_app():
    ...
    with st.sidebar:
        ...
        # 3. Engine Selection (Label Hidden & CSS Fix Applied)
        filter_method = st.radio(
    ...
    st.markdown(f"""
        ...
        /* MODERN RADIO BUTTON - FIX EMPTY TILE */
        
        /* 1. Hide the Main Widget Label completely */
        [data-testid="stSidebar"] .stRadio > label {
        ...
        [data-testid="stSidebar"] .stRadio > div {
            flex-direction: row;
            gap: 10px;
            margin-top: -10px; /* Pull up slightly to sit flush with divider */
        }
